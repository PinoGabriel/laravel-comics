...
return [
    ...
    "loghi" => [
        [
            "img" => "/assets/images/buy-comics-digital-comics.png",
            "desc" => "digital comics"
        ],
        [
            "img" => "/assets/images/buy-comics-merchandise.png",
            "desc" => "dc merchandise"
        ],
        [
            "img" => "/assets/images/buy-comics-subscriptions.png",
            "desc" => "subscription"
        ],
        [
            "img" => "/assets/images/buy-comics-shop-locator.png",
